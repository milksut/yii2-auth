...
<div class="flex h-screen w-full overflow-hidden font-[Inter,sans-serif]">
    ...
    <div class="flex h-full w-full flex-col items-center justify-center overflow-y-auto bg-white p-8 lg:p-12 lg:w-1/2">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-10">
                <h2 class="text-3xl font-bold text-slate-900"><?= Module::t('Sign in to Command Center') ?></h2>
                <p class="mt-2 text-slate-500"><?= Module::t('Enter your credentials to access your dashboard') ?></p>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <label for="loginform-rememberme" class="ml-2 block text-sm font-medium text-slate-600"><?= Module::t('Remember Me') ?></label>
                </div>
                <div class="text-sm">
