...
<div class="flex h-screen w-full overflow-hidden font-[Inter,sans-serif]">
    ...
    <div class="flex h-full w-full flex-col items-center justify-center overflow-y-auto bg-white p-8 lg:p-12 lg:w-1/2">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-10">
                <h2 class="text-3xl font-bold text-slate-900"><?= Module::t('Secure Password Recovery') ?></h2>
                <p class="mt-2 text-slate-500"><?= Module::t('Enter your enterprise email to receive recovery instructions.') ?></p>
            </div>
